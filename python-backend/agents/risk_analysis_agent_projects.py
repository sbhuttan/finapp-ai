"""
Risk Analysis Agent using Azure AI Projects
...
def parse_risk_analysis(analysis_text: str, symbol: str) -> RiskAnalysis:
    ...
    try:
        ...
        return RiskAnalysis(
            ...
            risk_summary=risk_summary or analysis_text
        )
        ...
        return RiskAnalysis(
            ...
            overall_risk_rating="Medium",
            risk_score=5.0,
            financial_risks={"rating": "Medium", "score": 5.0, "summary": "", "key_risks": []},
            market_risks={"rating": "Medium", "score": 5.0, "summary": "", "key_risks": []},
            operational_risks={"rating": "Medium", "score": 5.0, "summary": "", "key_risks": []},
            regulatory_risks={"rating": "Medium", "score": 5.0, "summary": "", "key_risks": []},
            risk_factors=[],
            risk_mitigation=[],
